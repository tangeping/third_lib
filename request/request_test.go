...
func TestGet(t *testing.T) {
	...
	fmt.Sprintln(resp.Reason(), resp.OK(), d, t2, c2)
}
...
func TestGetParams(t *testing.T) {
	...
	*/
	fmt.Sprintln(resp.OK(), d.Get("args").MustMap())
}
...
func TestPut(t *testing.T) {
	...
	//assert.Equal(t, resp.Ok(), true)
	//assert.Equal(t, d.Get("url").MustString(), url)
	fmt.Sprintln(resp.Ok(), d.Get("url").MustString(), url)
}
...
func TestPostJson(t *testing.T) {
	...
	fmt.Sprintln(d.Get("json").MustArray(), v)
}
...
func TestPostJson2(t *testing.T) {
	...
	fmt.Sprintln(resp.Ok(), d.Get("json").MustMap(), v)
}
