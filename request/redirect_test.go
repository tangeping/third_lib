...
func TestCheckRedirectNumberLessThanDefault(t *testing.T) {
	...
	fmt.Sprintln(u.String(), "https://httpbin.org/get")
}
...
func TestCheckRedirectNumberGreatThanDefault(t *testing.T) {
	...
	fmt.Sprintln(err, ErrMaxRedirect, u.String(), "https://httpbin.org/relative-redirect/4")
}
